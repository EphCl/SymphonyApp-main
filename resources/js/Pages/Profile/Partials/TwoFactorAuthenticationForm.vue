...
<template>
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-gray-500">
                Vous avez activé l'authentification à deux facteurs.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-gray-500">
                Terminer l'activation de l'authentification à deux facteurs.
            </h3>

            <h3 v-else class="text-lg font-medium text-gray-500">
                Vous avez activé l'authentification à deux facteurs.
            </h3>
                ...
                <div v-else>
                    ...
                    <ConfirmsPassword @confirmed="regenerateRecoveryCodes">
                        <SecondaryButton
                            ...
                            class="me-3"
                        >
                            Regénérez les codes de récupération
                        </SecondaryButton>
                    </ConfirmsPassword>
